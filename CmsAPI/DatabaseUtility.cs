...
public class DatabaseUtility
{
    ...
    public static async Task EnsureDbCreatedAndSeedWithCountOfAsync(DbContextOptions<CmsContext> options, UserManager<User> userManager, int count)
    {
        ...
        {
            var seed = new SeedCms(userManager);
